...
public class UsuarioDao {
    ...
    private Usuario getUsuario(ResultSet result) throws SQLException {
        ...
        usuario.setDataHoraCriacao(result.getObject("dataHoracriacao", LocalDateTime.class));
        usuario.setUltimoLogin(result.getObject("ultimoLogin", LocalDateTime.class));
    ...
    public String deleteUsuarioPeloId(Long id) {
        ...
        try {
            ...
            return resultado == 1 ? "Usuário apagado com sucesso" : "Não foi possível apagar.";
    ...
    public void atualizarUltimoLogin(Usuario usuario) {
        ...
        try {
            ...
            System.out.println(String.format("Atualização do ultimo login: %s", 
